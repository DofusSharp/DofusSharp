...
/// </summary>
public class SpellLevel : DofusDbEntity
{
    /// <summary>
    ...
    /// </summary>
    public IReadOnlyCollection<SpellEffect>? CriticalEffects { get; init; }

    /// <summary>
    ///     The collection of preview zones for the spell at this level.
    /// </summary>
    public IReadOnlyCollection<SpellZoneDescription>? PreviewZones { get; init; }

    /// <summary>
    ///     The collection of effects applied when casting the spell.
    /// </summary>
    public IReadOnlyCollection<SpellEffect>? Effects { get; init; }
