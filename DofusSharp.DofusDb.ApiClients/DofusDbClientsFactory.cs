...
public class DofusDbClientsFactory(Uri baseAddress, Uri? referrer = null)
{
    ...
    public IDofusDbImageClient ItemImages() => new DofusDbImageClient(new Uri(baseAddress, "img/items/"), ImageFormat.Png, referrer);
    ...
    public IDofusDbScalableImageClient MapImages() => new DofusDbScalableImageClient(new Uri(baseAddress, "img/maps/"), ImageFormat.Jpeg, referrer);
