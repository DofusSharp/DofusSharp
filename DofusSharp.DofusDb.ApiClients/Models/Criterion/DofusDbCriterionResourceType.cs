...
public static class DofusDbCriterionResourceTypeExtensions
{
    ...
    public static IDofusDbTableClient CreateClientForCriterionResourceOfType(this IDofusDbClientsFactory clientsFactory, DofusDbCriterionResourceType type) =>
        type switch
        {
            ...
            DofusDbCriterionResourceType.AlignmentRanks           => clientsFactory.AlignmentRanks(),
            DofusDbCriterionResourceType.Alignments               => clientsFactory.AlignmentSides(),
            DofusDbCriterionResourceType.AllianceRights           => clientsFactory.AllianceRights(),
            ...
            DofusDbCriterionResourceType.GuildRights              => clientsFactory.GuildRights(),
