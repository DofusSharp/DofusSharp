...
public class DofusDbQuerySearchTest
{
    ...
    {
        IDofusDbQuery<DofusDbItemSet> query = DofusDbQuery.Beta(Constants.Referrer).ItemSets();
    ...
    {
        IDofusDbQuery<DofusDbItem> query = DofusDbQuery.Beta(Constants.Referrer).Items();
