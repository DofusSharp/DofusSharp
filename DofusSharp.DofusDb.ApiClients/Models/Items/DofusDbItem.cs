...
public class DofusDbItem : DofusDbResource
{
    ...
    /// </summary>
    public DofusDbItemType? Type { get; init; }
    ...
    ///     The description of the item.
    /// </summary>
    public DofusDbMultiLangString? ImportantNotice { get; init; }
    ...
    /// </summary>
    public DofusDbValueOrFalse<DofusDbItemSetMinimal>? ItemSet { get; init; }
    ...
    /// </summary>
    public IReadOnlyCollection<DofusDbItemEffect>? Effects { get; init; }
...
public static class DofusDbItemImagesExtensions
{
    /// <summary>
